...
REWARD_SCALAR = 10 # max reward value given when angle = 0 and 0 reward at +/- 15 degrees
...
class DQN_Env():
    ...
    def __init__(self):
        rospy.init_node('DQN_Env', anonymous=False)
    ...
    def step(self, action):
        ...
        if not done:
            ...
            if action == 0:
                move_cmd.angular.z = MAX_TURN_SPEED # 0.2 rad/s
            else:
                move_cmd.angular.z = -MAX_TURN_SPEED # -0.2 rad/s
